export type KnowledgeModule = '00_kb_governance' | '01_sources_permissions' | '02_company_identity' | '03_brand_messaging' | '04_product_catalog' | '05_manufacturing_quality' | '06_certification_compliance' | '07_commercial_delivery' | '08_market_intelligence' | '09_icp_buyer_personas' | '10_buyer_intent_signals' | '11_competitors_differentiation' | '12_product_market_fit' | '13_lead_discovery' | '14_customer_asset_lifecycle' | '15_inquiry_qualification' | '16_solution_quotation' | '17_objection_negotiation' | '18_sales_content_templates' | '19_order_delivery_aftersales' | '20_learning_metrics';
export type KnowledgeStatus = 'verified_fact' | 'public_fact' | 'ai_inference' | 'strategy_recommendation' | 'pending_supplement' | 'deprecated';
